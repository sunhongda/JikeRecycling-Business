...
import com.angm.jikeb.activity.H5PayDemoActivity;
import com.angm.jikeb.util.PayResult;
import com.angm.jikeb.util.SignUtils;
...
public class ExternalFragment extends LevelTwoFragment {
    // 商户PID
    ...
    protected void initView() {
        ...
        h5pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                h5Pay();
            }
