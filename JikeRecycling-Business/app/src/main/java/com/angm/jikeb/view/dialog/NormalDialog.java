...
import com.angm.jikeb.view.dialog.base.BaseAlertDialog;
...
public class NormalDialog extends BaseAlertDialog<NormalDialog> {
    ...
    public void setUiBeforShow() {
        ...
        if (style == STYLE_ONE) {
            ...
            tv_title.setVisibility(isTitleShow ? View.GONE : View.GONE);
        ...
        v_line_title.setVisibility(isTitleShow && style == STYLE_ONE ? View.GONE : View.GONE);
